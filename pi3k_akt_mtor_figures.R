################################################################################
##   PI3KAtlas — Pan-cancer alteration landscape of the PI3K–AKT–mTOR pathway
...
##   GitHub : https://github.com/siddugayam/PI3KAtlas
...
GENE_ORDER    <- c("PIK3CA", "PIK3CB", "PIK3R1", "PIK3R2", "PTEN", "INPP4B", "AKT1", "AKT2", "AKT3", "MTOR", "RICTOR", "RPTOR", "TSC1", "TSC2", "STK11")
GENE_CATEGORY <- c("PIK3CA"="PI3K", "PIK3CB"="PI3K", "PIK3R1"="PI3K", "PIK3R2"="PI3K", "PTEN"="Negative regulator", "INPP4B"="Negative regulator", "AKT1"="AKT", "AKT2"="AKT", "AKT3"="AKT", "MTOR"="mTOR complex", "RICTOR"="mTOR complex", "RPTOR"="mTOR complex", "TSC1"="Upstream / TSC", "TSC2"="Upstream / TSC", "STK11"="Upstream / TSC")
CAT_COLORS    <- c("PI3K"="#534AB7", "Negative regulator"="#1D9E75", "AKT"="#D85A30", "mTOR complex"="#185FA5", "Upstream / TSC"="#D4537E")
...
combined <- (fig2 | fig4) / (fig3 + theme(plot.margin = unit(c(0,1,0,0),"cm"))) +
  ...
  plot_annotation(title = "PI3KAtlas: Pan-cancer alteration landscape of the PI3K–AKT–mTOR pathway",
    subtitle = paste0("TCGA PanCancer Atlas 2018 - ", NGENES, " genes - 32 tumour types - n = 10,195"),
    caption = "Data: cBioPortal public API - github.com/siddugayam/PI3KAtlas",
